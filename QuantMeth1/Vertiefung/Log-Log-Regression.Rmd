...
2. [Log-Regression](#log-regression)
3. [Log-Log-Regression](#log-log-regression)
4. [Fazit](#fazit)
]]
...
Wie ist der Zusammenhang von X und Y in einer Log-Log-Regression zu verstehen?
